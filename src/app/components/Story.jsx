  ...
  return (
    <div className="relative">
        ...
        {isUser ?<img src="https://www.svgrepo.com/show/313146/minus-plus.svg"
         className="text-blue-700 text-sm h-6 absolute top-10 left-9 border-2 border-white border-spacing-1 rounded-full bg-white transform transition-transform hover:scale-110 ease-out duration-200" />:null }
    </div>
  )
}
